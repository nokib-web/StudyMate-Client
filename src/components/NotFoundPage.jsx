  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-base-200 text-center p-6">
      <div className="card bg-base-100 shadow-xl p-10 max-w-md">
        <h1 className="text-7xl font-extrabold my-text-primary mb-4">404</h1>
        ...
        <div className="flex flex-col gap-3">
          <Link to="/" className="btn my-btn-primary w-full flex items-center justify-center gap-2">
            <FaHome className="w-4 h-4" /> Back to Home
          </Link>
          <Link to="/find-partners" className="btn my-btn-outline w-full flex items-center justify-center gap-2">
