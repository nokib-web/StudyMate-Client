...
const CreatePartnerProfile = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto my-10 p-6 bg-base-200 rounded-2xl shadow-lg mt-10">
            <h2 className="text-3xl my-text-primary font-bold text-center mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="text-center pt-3">
                    <button type="submit" className="btn my-btn-primary px-8 py-2  shadow-lg hover:shadow-xl hover:scale-105 transition-transform">
                        Create Profile
                    </button>
                </div>
            </form>
