...
const HowItWorks = () => {
  return (
    <section className="py-16 px-6 md:px-16 text-center bg-base-100">
      <h2 className="text-3xl font-bold mb-10 my-text-primary">How It <span className="my-text-secondary">Works</span></h2>
      <div className="grid md:grid-cols-3 gap-8">
        {/* Step 1 */}
        <div className="card bg-base-200 shadow-sm hover:shadow-md transition rounded-2xl">
          <div className="card-body items-center">
            <FaUserFriends className="text-4xl my-text-secondary mb-3" />
        ...
        <div className="card bg-base-200 shadow-sm hover:shadow-md transition rounded-2xl">
          <div className="card-body items-center">
            <FaBookOpen className="text-4xl my-text-secondary mb-3" />
        ...
        <div className="card bg-base-200 shadow-sm hover:shadow-md transition rounded-2xl">
          <div className="card-body items-center">
            <FaRegLightbulb className="text-4xl my-text-secondary mb-3" />
